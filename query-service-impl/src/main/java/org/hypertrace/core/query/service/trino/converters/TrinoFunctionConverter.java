...
public class TrinoFunctionConverter {
  ...
  private final TrinoFunctionConverterConfig config;

  public TrinoFunctionConverter(
      TableDefinition tableDefinition, TrinoFunctionConverterConfig config) {
    this.tableDefinition = tableDefinition;
    this.config = config;
  }

  public TrinoFunctionConverter(TableDefinition tableDefinition) {
    this(tableDefinition, new TrinoFunctionConverterConfig());
  }
  ...
  public String convert(
    ...
    switch (function.getFunctionName().toUpperCase()) {
      ...
      case "DISTINCTCOUNTMV":
        return this.toDistinctCount(function, argumentConverter, trinoExecutionContext);
      ...
      case QUERY_FUNCTION_AVGRATE:
        ...
        return this.functionToStringForAvgRate(function, argumentConverter, trinoExecutionContext);
  ...
  private String functionToStringForAvgRate(
    ...
    ExecutionContext executionContext = trinoExecutionContext.getExecutionContext();
  ...
  private String toDistinctCount(
    ...
    if (trinoExecutionContext.getColumnRequestContext().isArrayColumnType()) {
      trinoExecutionContext.addUnnestTableColumnName(argument);
    }
